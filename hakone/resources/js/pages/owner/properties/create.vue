...
// Handle perubahan input file dan siapkan preview image.
...
// Image preview akan ditampilkan sebelum upload, sekaligus menyimpan file ke form.cover_image.

const submit = () => {
    form.post(route('owner.properties.store'), {
        forceFormData: true,
    })
};
...
<template>
    ...
    <Head title="Tambah Property" />

    <div class="p-6">
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-foreground">Tambah Property</h1>
                <p class="mt-2 text-sm text-muted-foreground">Isi data properti baru untuk publikasi.</p>
            </div>
        ...
        <Card>
            <CardHeader>
                <CardTitle>Form Tambah Property</CardTitle>
                <CardDescription>Lengkapi data properti berikut lalu submit untuk menyimpan.</CardDescription>
            </CardHeader>
