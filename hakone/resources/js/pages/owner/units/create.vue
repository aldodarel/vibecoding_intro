...
const submit = (): void => {
    ...
    form.post(route('owner.properties.units.store', props.property.id));
};
</script>
...
<template>
    ...
    <div class="p-6 space-y-6">
        <div class="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-foreground">Tambah Unit</h1>
                <p class="mt-1 text-sm text-muted-foreground">
                    Tambahkan unit baru untuk property {{ props.property.name }}.
                </p>
            </div>
        ...
        <Card>
            <CardHeader>
                <CardTitle>Form Tambah Unit</CardTitle>
            </CardHeader>
